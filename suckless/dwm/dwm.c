...
enum { SchemeNorm, SchemeSel, SchemeHl, SchemeLt, SchemeSeLt,
       SchemeGr, SchemeGrHl, SchemeRd, SchemeRdHl}; /* color schemes */
...
drawbar(Monitor *m)
{
	...
	for (i = 0; i < LENGTH(tags); i++) {
		w = TEXTW(tags[i]);
		drw_setscheme(drw, scheme[m->tagset[m->seltags] & 1 << i ? SchemeHl : SchemeNorm]);
